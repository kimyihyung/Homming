...
<body>
            ...
            <section class="search_search_section" id="passFilter">
                ...
                <section class="search_list_section">
                    <div class="search__inner">
                        <div class="search" data-category="초보자용">
                        ...
                        <div class="search" data-category="반려동물 안전한">
                            <div class="plant__image"
                        ...
                        <div class="search" data-category="다육/선인장">
                            <div class="plant__image"
    ...
    function filter() {
        ...
        for (let i = 0; i < search.length; i++) {
            plant = search[i].getElementsByClassName("search__contents");
    ...
    let main = document.querySelector('.search__inner').children;
