        ...
        <section id="plantmoaView" class="container">
            <div class="plantmoaView__inner">
                ...
                <div class="plantmoaView__contents">
                    <div class="title">
                        <h1>Philodendron nangaritense</h1>
                        <h2>필로덴드론 낭가리텐스</h2>
                    </div>
                    ...
                    <div class="plantmoaView__con">
                        <p>
                            필로덴드론 낭가리텐스는 얇고 윤기나는 하트모양의 녹색잎과 잎맥이 돋보이는 식물이에요. 잎 뒷면은 흰빛이 도는 매트한 질감을 가지고 있고, 붉은 빛을 띠는 줄기에는 털이 보송보송 나있어 특이한 외모를 자랑한답니다. 에콰도르에서 온 낭가리텐스는 원산지에서는 땅을 기어가며 자란다고해요. 집에서 기를 때 지지대를 해주지 않으면 화분 밑을 향해 자라는 게 그 이유랍니다. 따뜻한 온도를 좋아하고 주변 공기를 촉촉하게 관리해주면 건강하게 잘 키울 수 있어요.
                        </p>
                    </div>
                ...
                <div class="plantmoaInfo__inner2">
                    <div class="tabInfo active">
                        ...
                        <div class="plantmo__Water">
                            ...
                            낭가리텐스는 촉촉한 공기는 좋아하지만, 뿌리 과습에는 약해요. 흙이 너무 축축하게 오래 지속되면 잎에 힘이 없이 축 처질 수 있어 물을 주기 전 항상 흙의 마름 정도를 파악한 후 물을 주세요. 화분 위에서 3~5cm 정도 높이의 흙이 보송하게 마르면 물을 주세요. 물을 주실 때는 화분 밑으로 물이 빠져나올 때까지 충분히 주셔야 흙 전체에 충분히 물이 흡수될 수 있답니다. 물을 준 후에는 화분받침에 고인 물은 바로 버려주셔야 뿌리의 호흡을 도울 수 있어요.
                            </p>
                ...
                <div class="plantmoaInfo__inner2">
                    <div class="tabInfo">
                        ...
                        <div class="plantmo__Water">
                            ...
                            <p class="plantInfo__desc">
                         낭가리텐스는 큰 나무 아래에서 자라던 식물로, 부드러운 걸러진 빛을 가장 좋아한답니다. 밝은 간접광이 오래 들어오는 공간에 두시고, 직접적인 강한 빛은 피해주세요.   </p>
                            <h3 class="plantInfo__tit2">빛이 너무 강하면</h3>
                            <p class="plantInfo__desc2">
                            낭가리텐스는 뜨거운 직접적인 햇빛 아래에서는 잎 끝이 탈 수 있어 커튼이나 블라인드로 약간의 차광을 해주시는 게 좋아요. </p>
                            <h3 class="plantInfo__tit3">빛이 너무 약하면</h3>
                            <p class="plantInfo__desc3">
                               빛이 너무 약하면 잎이 노랗게 바라고, 줄기가 힘이 없어져 축 처져 자라는 현상이 나타날 수 있어요. 줄기가 튼튼한 낭가리텐스를 만나기 위해서는 더 밝은 빛을 받을 수 있는 곳으로 옮겨주세요.
                            </p>
                        </div>
                    </div>
                </div>
                <div class="plantmoaInfo__inner2">
                    <div class="tabInfo">
                        ...
                        <div class="plantmo__Water">
                            ...
                            <p class="plantInfo__desc">
                               낭가리텐스는 높은 습도를 아주 좋아해요. 가습기를 이용해 주변 습도를 높게 관리해주세요. 잎에 직접적으로 분무하는 것보다 식물 근처에 분모해서 주변의 습도를 높여주세요.
                            </p>
                            <h3 class="plantInfo__tit2">습도가 낮으면</h3>
                            <p class="plantInfo__desc2">
                           습도가 낮아 건조해지면 잎 끝에 수분이 부족한 듯이 갈색으로 마르고, 새 순에 상처가 생길 수 있어요. 또한 습도가 너무 낮은 환경이 지속되면 식물이 뿌리로부터 물을 잘 끌어올릴 수 없게 되어 잎 끝이 마르거나 잎이 떨어질 수 있어요. 따라서 주변 공간의 습도가 너무 낮다면(40% 이하) 분무기를 이용해 식물 주변의 습도를 높여주시거나 가습기를 사용해주시는 게 좋아요. 가습기와 서큘레이터를 함께 이용하면 한 곳의 습도만 높아지는 것을 방지할 수 있답니다.     </p>
                            <h3 class="plantInfo__tit3">습도가 높으면</h3>
                            <p class="plantInfo__desc3">
                         습도가 높게 지속되면서 공기를 순환시켜주지 않으면 병충해가 생기기 쉬운 환경이 만들어져요. 따라서 환기를 자주 해주시거나 가습기와 서큘레이터를 함께 이용해 공기를 순환시켜 주는 게 좋아요.   </p>
                        </div>
                    </div>
                </div>
                <div class="plantmoaInfo__inner2">
                    <div class="tabInfo">
                        ...
                        <div class="plantmo__Water">
                            ...
                            <p class="plantInfo__desc">
                          낭가리텐스는 고온다습한 열대우림에서 온 식물이에요. 추위에 약해 주변 온도를 따뜻하게 관리해주셔야 한답니다. 만약 실외에서 키우고 계시다면, 늦가을~초봄까지는 실내로 들여서 키워주셔야 건강하게 키울 수 있습니다.   </p>
                            <h3 class="plantInfo__tit2">온도가 낮으면</h3>
                            <p class="plantInfo__desc2">
                              낭가리텐스는 차가운 온도에 예민해요. 특히 찬 바람에 아주 약해 우풍을 맞지 않는 공간에 놓아주세요. 날씨가 쌀쌀해지는 늦가을에서 겨울에는 식물의 지상부(흙 위의 드러난 부분; 줄기, 잎)가 냉해를 입을 수 있고 흙의 온도가 낮아지면 지하부(흙 아래 심겨진 부분)까지 영향을 미칠 수 있어요. 겨울철에도 건강하게 생육을 지속하고 싶으시다면 실내 온도를 15ºC 이상으로 관리해주세요. 온도가 낮아지면 잎이 얼어 잎 색이 변하고 가지가 축 늘어지는 냉해를 입을 수 있어요.
                            </p>
                            <h3 class="plantInfo__tit2">온도가 높으면</h3>
                            <p class="plantInfo__desc3">
                               따뜻한 봄과 초여름에는 낭가리텐스가 잎을 마구마구 내는 모습을 만날 수 있어요. 하지만 한여름 낮의 뜨거운 온도가 지속되면 잎과 뿌리의 호흡이 불량해질 수 있으니 30ºC 이상의 고온의 장소는 피해주세요.
                            </p>
                        </div>
                    </div>
                </div>
