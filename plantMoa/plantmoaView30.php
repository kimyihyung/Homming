            ...
            <div class="plantmoaView__inner">
                ...
                <div class="plantmoaView__contents">
                    ...
                    <div class="plantmoaView__con">
                        <p>
                           목성 베고니아는 줄기가 단단하게 목질화되는 것처럼 자라나는 베고니아의 한 종류에요. 불규칙한 모양의 잎에 하얀 점박이 귀여운 무늬가 있는 목성 베고니아는 키가 아주 크게 자라고, 다른 베고니아 종류에 비해 키우기 까다롭지 않아 홈가드닝 식물로 아주 인기가 많답니다.잎 꽂이만으로도 번식이 잘 되어서 베고니아를 처음 도전하시는 분들께 추천드리는 식물입니다.
                        </p>
                    </div>
                ...
                <div class="plantmoaInfo__inner2">
                    <div class="tabInfo">
                        ...
                        <div class="plantmo__Water">
                            ...
                            <p class="plantInfo__desc">
                              베고니아는 빛이 적은 실내에서도 잘 견디지만 밝고 은은한 간접광이 오래 드는 곳에서 가장 잘 자라요.


                            </p>
                            <h3 class="plantInfo__tit2">습도가 낮으면</h3>
                            <p class="plantInfo__desc2">
                            직접적인 강한 햇빛 아래에서는 잎에 갈색 반점이 생기거나 잎 끝이 탈 수 있으니 한낮에는 커튼이나 블라인드로 약간의 차광을 해주시는 게 좋아요.     </p>
                    ...
                    <div class="tabInfo">
                        ...
                        <div class="plantmo__Water">
                          ...
                          습도가 낮아 건조해지면 잎 끝이 마르고 잎이 쪼글쪼글해지는 증상이 나타나요. 또한 습도가 너무 낮은 환경이 지속되면 식물이 뿌리로부터 물을 잘 끌어올릴 수 없게 되어 잎 끝이 마르거나 잎이 떨어질 수 있어요. 따라서 주변 공간의 습도가 너무 낮다면(40% 이하) 분무기를 이용해 식물 주변의 습도를 높여주시거나 가습기를 사용해주시는 게 좋아요. 가습기와 서큘레이터를 함께 이용하면 한 곳의 습도만 높아지는 것을 방지할 수 있답니다.    </p>
                            ...
                            <p class="plantInfo__desc3">
                          잎이 무거워 처지는 느낌이 들고, 잎이 무를 수 있어요. 습도가 높게 지속되면서 공기를 순환시켜주지 않으면 병충해가 생기기 쉬운 환경이 만들어져요. 따라서 환기를 자주 해주시거나 가습기와 서큘레이터를 함께 이용해 공기를 순환시켜 주는 게 좋아요.   </p>
                        </div>
                    </div>
                </div>
            </div>
