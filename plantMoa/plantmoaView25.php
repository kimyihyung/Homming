          ...
          <section id="plantmoaView" class="container">
            <div class="plantmoaView__inner">
                <figure class="plantmoaView__img">
                    <img src="../html/assets/img/plantmoaView25.jpg" alt="">
                </figure>
                <div class="plantmoaView__contents">
                    <div class="title">
                        <h1>Cereus jamacaru</h1>
                        <h2>귀면각 선인장 (연성각)</h2>
                    </div>
                    ...
                    <div class="plantmoaView__con">
                        <p>
                            귀면각은 위로 길쭉하게 자라는 생김새가 기둥을 닮아 기둥 선인장으로도 불리우는 선인장이에요. 번식이 잘 되는 편이라 아주 작은 크기의 미니 귀면각부터, 2m가 훌쩍
                            넘는 대형 귀면각까지 생김새와 크기가 다양하답니다.
                            단단한 몸통에는 수분을 많이 머금을 수 있어 물을 자주 주지 않아도 되고, 건조한 습도와 강한 햇빛이 있는 공간을 좋아해요. 워낙 순둥순둥해서 다른 종류의
                            선인장류들과 합식(한 화분에 함께 심음)해도 잘 자란답니다.
                            작은 크기의 미니 귀면각의 가시는 아주 얇지만, 크기가 큰 귀면각은 그 가시도 단단해 상처를 입을 수 있으니 주의해주세요.
                        </p>
                    </div>
                        ...
                        <ul class="notice-items">
                            ...
                            <div class="notice-items-flex">
                                ...
                                <li class="notice-item">
                                    ...
                                    <h4 class="notice-item-desc">18~28℃의 온도에서 잘 자라요</h4>
                                </li>
                            </div>
                        </ul>
                    </div>
                    ...
                    <div class="tabInfo active">
                        ...
                        <div class="plantmo__Water">
                            ...
                            <p class="plantInfo__desc">
                                귀면각은 두꺼운 줄기에 수분을 많이 머금고 있어 건조한 환경에 견디는 능력이 뛰어나요. 흙이 다 마르기 전에 물을 주면 몸통이 물러버릴 수 있으니 꼭 흙이
                                마른 것을 확인한 후에 물을 주셔야해요. 물을 주실 때는
                                몸통에 직접 닿지 않게 주셔야 무름을 방지할 수 있답니다. 너무 차갑지 않은 온도의 물을 듬뿍 주세요. 물을 준 후에는 받침대에 고인 물을 바로 버리고,
                                통풍이 잘 되는 곳에 두세요.
                            </p>
                            <h3 class="plantInfo__tit2">여름</h3>
                            <p class="plantInfo__desc2">
                                성장이 빨라지는 봄~여름에는 흙 마름도 빨라져 물 주는 횟수를 늘려주시는 게 좋아요. 무더운 여름철에는 가장 더운 시간을 피해 저녁에 물을 주세요. 물을 준
                                후 흙의 온도가 함께 올라가 뿌리가 상할 수 있어요.
                            </p>
                            <h3 class="plantInfo__tit3">겨울</h3>
                            <p class="plantInfo__desc3">
                                날씨가 추워지는 늦가을~겨울에는 휴면기에 돌입 성장속도가 매우 느려져 흙 마름도 더뎌진답니다. 따라서 물 주는 횟수를 더 줄여주시는 게 좋아요. 겨울철에는
                                날씨가 가장 따뜻한 낮에 너무 차갑지 않은 온도의 물을
                                주시는 게 좋아요.
                            </p>
                        </div>
                    </div>
                ...
                <div class="plantmoaInfo__inner2">
                    <div class="tabInfo">
                        ...
                        <div class="plantmo__Water">
                            ...
                            <p class="plantInfo__desc">
                                귀면각은 밝은 빛을 좋아하는 식물이에요. 가장 밝은 빛이 오래 머무는 곳에서 키워주세요.
                            </p>
                ...
                <div class="plantmoaInfo__inner2">
                    <div class="tabInfo">
                        ...
                        <div class="plantmo__Water">
                            ...
                            <p class="plantInfo__desc">
                                귀면각은 건조한 환경을 좋아해요. 평균 실내 습도에서 무난히 잘 자라며, 장마철의 높은 습도에서는 몸통이 물러지지 않도록 주의가 필요하답니다.
                            </p>
                            <h3 class="plantInfo__tit2">습도가 낮으면</h3>
                            <p class="plantInfo__desc2">
                                귀면각은 건조한 습도를 좋아해요. 주변 습도가 높아지지 않도록 주의해주세요.
                            </p>
                            <h3 class="plantInfo__tit3">습도가 높으면</h3>
                            <p class="plantInfo__desc3">
                                습도가 너무 높은 환경이 지속되면 몸통이 마를 수 있고, 병충해가 생기기 쉬우므로 환기를 자주 해주시거나 서큘레이터를 이용해 공기를 순환시켜 주는 게 좋아요.
                                높은 습도의 장마철에는 제습기를 이용하여 주변 습도를
                                관리해 주시는 것을 추천드립니다.
                            </p>
                        </div>
                    </div>
                ...
                <div class="plantmoaInfo__inner2">
                    <div class="tabInfo">
                        ...
                        <div class="plantmo__Water">
                            ...
                            <p class="plantInfo__desc">
                                귀면각은 따뜻한 온도를 좋아하는 식물입니다. 한겨울의 추위만 피해주신다면 건강하게 키우실 수 있어요.
                            </p>
                            <h3 class="plantInfo__tit2">온도가 낮으면</h3>
                            <p class="plantInfo__desc2">
                                온도가 낮아지는 늦가을~겨울에는 추위를 피해 따뜻한 실내에서 키워주시는 것이 좋아요. 찬바람이 드나드는 곳도 피해주세요. 특히 10℃ 이하의 온도에서는 냉해를
                                입어 몸통이 얼어 물러버릴 수 있어요.
                            </p>
                            <h3 class="plantInfo__tit2">온도가 높으면</h3>
                            <p class="plantInfo__desc3">
                                30℃가 넘는 여름철 한낮에 직접적인 강한 햇빛이 들어오는 공간에서는 화분 속 흙의 온도도 함께 올라가 뿌리가 상할 수 있으니 주의해주세요.
                            </p>
                        </div>
                    </div>
                </div>
