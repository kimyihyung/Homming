       ...
       <section id="plantmoaView" class="container">
            <div class="plantmoaView__inner">
                <figure class="plantmoaView__img">
                    <img src="../html/assets/img/plantmoaView13.jpeg" alt="">
                </figure>
                <div class="plantmoaView__contents">
                    <div class="title">
                        <h1>Codiaeum variegatum 'Banana'</h1>
                        <h2>바나나 크로톤</h2>
                    </div>
                    ...
                    <div class="plantmoaView__con">
                        <p>
                            바나나 보양의 잎에 선명한 노란 무늬가 있는 바나나 크로톤은 색감이 예쁘고 키우기 쉬워 오랫동안 사랑받는 실내 공기정화 식물이에요. 바나나 크로톤은 실내광에서도 잘
                            자라지만 빛이 적은 곳에 두면 잎의 무늬가 옅어지고
                            녹색으로 변해요. 무늬가 또렷하게 보이게 하려면 은은한 빛이 밝게 오래 드는 곳에서 키우는 것이 좋아요. 따뜻한 열대지역에서 온 크로톤은 온도에 예민한 식물이에요.
                            주변 온도를 항상 따뜻하게 유지해주어야 건강하게 잘
                            키울 수 있어요.
                        </p>
                    </div>
                        ...
                        <ul class="notice-items">
                            ...
                            <div class="notice-items-flex">
                                ...
                                <li class="notice-item">
                                    ...
                                    <h4 class="notice-item-desc">21~27℃의 온도에서 잘 자라요</h4>
                                </li>
                            </div>
                        </ul>
                    </div>
                    ...
                    <div class="tabInfo active">
                        ...
                        <div class="plantmo__Water">
                            ...
                            <p class="plantInfo__desc">
                                크로톤은 흙이 축축한 것은 좋아하지 않아 화분 위에서 3~5cm 정도 높이까지 보송하게 마른 것을 확인한 후 물을 주시는 게 좋아요. 흙의 축축한 상태가 오래
                                지속되면 뿌리가 숨을 잘 쉴 수 없게 만들어 뿌리썩음을
                                유발할 수 있어요. 또한 온도 변화에 예민해 물을 주실 때는 너무 차가운 온도의 물 보다 살짝 미지근한 온도의 물을 주는 게 좋아요. 물을 주실 때는 화분
                                밑으로 물이 빠져나올 때까지 천천히, 그리고 충분히 주셔야
                                흙 전체에 충분히 물이 흡수될 수 있답니다.
                            </p>
                ...
                <div class="plantmoaInfo__inner2">
                    <div class="tabInfo">
                        ...
                        <div class="plantmo__Water">
                            ...
                            <p class="plantInfo__desc">
                                크로톤은 은은한 밝은 빛을 좋아해요. 직접적인 강한 빛 아래에서는 잎 끝이 탈 수 있으니 주의해주세요.
                            </p>
                            <h3 class="plantInfo__tit2">빛이 너무 강하면</h3>
                            <p class="plantInfo__desc2">
                                크로톤의 아름다운 무늬는 밝은 빛을 많이 받을수록 선명해지지만, 직접적인 강한 햇빛 아래에서는 잎이 갈색으로 타 들어갈 수 있으니 한낮에는 커튼이나 블라인드로
                                약간의 차광을 해주시는 게 좋아요.
                            <h3 class="plantInfo__tit3">빛이 너무 약하면</h3>
                            <p class="plantInfo__desc3">
                                빛이 너무 약하면 잎 무늬가 옅어지고 잎이 떨어지는 현상이 나타날 수 있어요. 또한 줄기가 얇아지고 웃자라는 현상이 나타날 수 있으니 밝은 공간으로 서서히
                                옮겨주시는 것이 좋아요.
                            </p>
                        </div>
                    </div>
                ...
                <div class="plantmoaInfo__inner2">
                    <div class="tabInfo">
                        ...
                        <div class="plantmo__Water">
                            ...
                            <p class="plantInfo__desc">
                                크로톤은 주변 습도가 낮으면 아랫잎이 쉽게 떨어지는 특징이 있어요. 보통 실내 습도에 잘 적응하지만 아침 저녁으로 분무를 통해 습도를 높여주시면 더 건강하게
                                잘 키울 수 있답니다.
                            </p>
                            <h3 class="plantInfo__tit2">습도가 낮으면</h3>
                            <p class="plantInfo__desc2">
                                건조한 환경에서는 크로톤의 잎이 쪼글쪼글해질 수 있어요. 또한 습도가 너무 낮은 환경이 지속되면 식물이 뿌리로부터 물을 잘 끌어올릴 수 없게 되어 잎 끝이
                                마르거나 잎이 떨어질 수 있어요. 고온건조한 환경에서는
                                응애, 총채벌레가 발생하기 쉬우므로 주변 공간의 습도가 너무 낮다면(40% 이하) 분무기를 이용해 식물 주변의 습도를 높여주시거나 가습기를 사용해주시는 게
                                좋아요. 가습기와 서큘레이터를 함께 이용하면 한 곳의 습도만
                                높아지는 것을 방지할 수 있답니다.
                            </p>
                            <h3 class="plantInfo__tit3">습도가 높으면</h3>
                            <p class="plantInfo__desc3">
                                크로톤은 추위에 아주 약하고 온도변화에 예민한 식물이에요. 온도 변화가 심한 창가나 에어컨, 난방기구 아래에 두지 마세요. 특히 차가운 바람이 드나드는 곳은
                                피해주셔야 잎이 떨어지는 것을 방지할 수 있어요.
                            </p>
                        </div>
                    </div>
                </div>
