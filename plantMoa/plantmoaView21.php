         ...
         <section id="plantmoaView" class="container">
            <div class="plantmoaView__inner">
                <figure class="plantmoaView__img">
                    <img src="../html/assets/img/plantmoaView21.jpeg" alt="">
                </figure>
                <div class="plantmoaView__contents">
                    <div class="title">
                        <h1>Pleiospilos nelii</h1>
                        <h2>제옥 (플레이오스필로스 넬리)</h2>
                    </div>
                    ...
                    <div class="plantmoaView__con">
                        <p>
                            제옥은 마치 코뿔소를 연상시키는 특이한 모양의 다육식물입니다. 흙 가까이에서 뽈록 솟아오른 돌 같이 보이기도 해 서양에서는 'Split Rock'이라고 불려요.
                            이러한 특이한 외형은 제옥이 살아남기 위해 특별하게
                            진화된 결과물이에요. 남아프리카의 건조한 사막지대에서 온 제옥은 주변 바위틈이나 자갈들 사이에서 성장하는데, 다른 동물들로부터 자신의 몸을 보호하기 위해 주변 색과
                            비슷한 색과 질감으로 자란다고 해요. 가을에 새
                            잎을 낼 때 제옥은 파충류처럼 '탈피'를 해요. 오래된 잎이 벌어지면 그 사이에서 새 잎이 나오는 신기한 식물이랍니다.
                        </p>
                    </div>
                    ...
                    <div class="tabInfo active">
                        ...
                        <div class="plantmo__Water">
                            ...
                            <p class="plantInfo__desc">
                                제옥은 통통한 잎에 수분을 많이 머금고 있어 물을 자주 주지 않아도 잘 자라요. 화분 속 흙이 바싹 마르고, 통통한 잎이 쭈글해진 것을 확인한 후에 물을
                            ...
                            <p class="plantInfo__desc2">
                                기온이 높게 올라가는 여름철(6월~8월)은 제옥이 성장을 멈추는 휴면기입니다. 휴면기에 물을 주게 되면 수분이 흡수되지 않고 머물러 있기 때문에 무름병이 쉽게
                                올 수 있는 환경이 되어요. 가을에 새 잎을 내어줄 수
                                있도록 여름철에는 물을 주지 마세요.
                            </p>
                            <h3 class="plantInfo__tit3">겨울</h3>
                            <p class="plantInfo__desc3">
                                기온이 낮아지는 겨울철(12월~3월)은 제옥이 성장을 멈추는 휴면기입니다. 겨울잠을 푹 자고 이듬해 봄에 건강하게 성장할 수 있도록 물을 주지 마시고, 따뜻한
                                곳에서 통풍이 잘 되도록 관리해주세요.
                            </p>
                        </div>
                    </div>
                </div>
                <div class="plantmoaInfo__inner2">
                    <div class="tabInfo">
                        ...
                        <div class="plantmo__Water">
                            ...
                            <p class="plantInfo__desc">
                                제옥은 강렬한 햇빛을 좋아하는 다육식물입니다. 강한 빛을 하루 6시간 이상 받을 수 있는 공간이 적합해요.
                            </p>
                ...
                <div class="plantmoaInfo__inner2">
                    <div class="tabInfo">
                        ...
                        <div class="plantmo__Water">
                            ...
                            <p class="plantInfo__desc">
                                제옥은 평균 실내 습도에서 문제없이 잘 자라요. 다만, 여름철 높은 습도에는 주의가 필요해요.
                            </p>
                            ...
                            <p class="plantInfo__desc2">
                                ...
                                근처에 두는 등 제옥 근처의 습도를 살짝 높여주시는 게
                                좋아요.
                            </p>
                ...
                <div class="plantmoaInfo__inner2">
                    <div class="tabInfo">
                        ...
                        <div class="plantmo__Water">
                            ...
                            <p class="plantInfo__desc">
                                제옥은 겨울의 추위만 주의해주시면 건강하게 키우실 수 있어요.
                            </p>
